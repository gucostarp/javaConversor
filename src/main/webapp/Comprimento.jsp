 		...
 		<nav class="navbar navbar-expand-lg navbar-light bg-light">
	  		<div class="container-fluid">
	        	...
	        	<div class="collapse navbar-collapse" id="navbarNavDropdown">
	        		<ul class="navbar-nav">
	        			<li class="nav-item">
	       					<a class="nav-link active" aria-current="page" href="./Comprimento.jsp">Comprimento</a>
        				</li>
	        			<li class="nav-item">
...
<hr>
<div>
		<label class="form-label text-center col-12 text-primary h5">Conversor de Comprimento</label>
</div>
<form action="Comprimento.jsp" method="get">
	...
	<div class="btn-group mt-2 mb-2 col-12 text-primary">
	  ...
	  <input type="radio" class="btn-check" name="options1" value="0.01" id="option3" autocomplete="off" <%= options1 == 0.01 ? "checked" : "" %>/>
	  <label class="btn btn-primary" for="option3">Centímetro</label>
	  
	  <input type="radio" class="btn-check" name="options1" value="0.001" id="option4" autocomplete="off" <%= options1 == 0.001 ? "checked" : "" %>/>
	...
	<div class="btn-group mt-2 mb-2 col-12 text-primary">
	  ...
	  <input type="radio" class="btn-check" name="options2" value="0.01" id="option7" autocomplete="off" <%= options2 == 0.01 ? "checked" : "" %>/>
	  <label class="btn btn-primary" for="option7">Centímetro</label>
	  
	  <input type="radio" class="btn-check" name="options2" value="0.001" id="option8" autocomplete="off" <%= options2 == 0.001 ? "checked" : "" %>/>
